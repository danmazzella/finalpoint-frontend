...
export default function LeagueDetailPage() {
  ...
  const loadRecentActivity = async (leagueId: number) => {
    try {
      ...
      console.log('Loading activity for league:', leagueId);
  ...
  const joinLeague = async () => {
    ...
    try {
      ...
      alert(error.response?.data?.message || 'Failed to join league. Please try again.');
    } finally {
      setJoining(false);
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white shadow rounded-lg p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4">League Information</h2>
